		...
		<?php foreach ($barang as $brg): ?>
			<div class="card ml-3 mb-3" style="width: 16rem;">
				...
				<div class="card-body">
				    ...
				    <?= anchor('dashboard/tambah_ke_keranjang/'. $brg->id_brg, '<div class="btn btn-sm btn-primary mb-2">Tambah Ke keranjang</div>')?>
				    <?= anchor('dashboard/detail/'. $brg->id_brg, '<div class="btn btn-sm btn-success mb-2">Detail</div>')?>
			  </div>
			</div>
		<?php endforeach; ?>
